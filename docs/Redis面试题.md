...
- RDB是Redis默认的持久化方式。按照一定的时间将内存的数据以快照的形式保存到硬盘中，对应产生的数据文件为dump.rdb。通过配置文件中的save参数来定义快照的周期。
  ...
  ![在这里插入图片描述](https://images.shiguangping.com/imgs/20200806110138)
...
- 当两种方式同时开启时，数据恢复Redis会优先选择AOF恢复
  ...
  ![在这里插入图片描述](https://images.shiguangping.com/imgs/20200806110229)
...
![在这里插入图片描述](https://images.shiguangping.com/imgs/20200806110346)
...
![在这里插入图片描述](https://images.shiguangping.com/imgs/20200806110357)
...
![在这里插入图片描述](https://images.shiguangping.com/imgs/20200806110410)
...
![在这里插入图片描述](https://images.shiguangping.com/imgs/20200806110422)
...
![在这里插入图片描述](https://images.shiguangping.com/imgs/20200806110433)
...
![在这里插入图片描述](https://images.shiguangping.com/imgs/20200806110451)
...
- 返回值：设置成功，返回 1 。设置失败，返回 0 。
  ...
  ![在这里插入图片描述](https://images.shiguangping.com/imgs/20200806110519)
...
作者：小杰要吃蛋
链接：https://juejin.im/post/6844904127055527950
来源：掘金
